...
const _NodeType_name = ""
...
var _NodeType_map = map[NodeType]string{
	...
	525:  _NodeType_name[2212:2218],
	530:  _NodeType_name[2218:2230],
	531:  _NodeType_name[2230:2252],
	532:  _NodeType_name[2252:2275],
	535:  _NodeType_name[2275:2285],
	1024: _NodeType_name[2285:2299],
}
