...
func _() {
	...
	_ = x[NodeMark-450]
	_ = x[NodeMarkOpenMarker-451]
	_ = x[NodeMarkCloseMarker-452]
	_ = x[NodeTypeMaxVal-1024]
}

const _NodeType_name = ""
...
var _NodeType_map = map[NodeType]string{
	...
	451:  _NodeType_name[1406:1424],
	452:  _NodeType_name[1424:1443],
	1024: _NodeType_name[1443:1457],
}
