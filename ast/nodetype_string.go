...
func _() {
	...
	_ = x[NodeBlockQueryEmbedScript-466]
	_ = x[NodeTypeMaxVal-1024]
}

const _NodeType_name = ""
...
var _NodeType_map = map[NodeType]string{
	...
	466:  _NodeType_name[1686:1711],
	1024: _NodeType_name[1711:1725],
}
