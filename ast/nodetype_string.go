...
func _() {
	...
	_ = x[NodeVirtualSpan-550]
	_ = x[NodeVirtualSpanOpenMarker-551]
	_ = x[NodeVirtualSpanCloseMarker-552]
	_ = x[NodeTypeMaxVal-1024]
}

const _NodeType_name = ""
...
var _NodeType_map = map[NodeType]string{
	...
	531:  _NodeType_name[2141:2163],
	532:  _NodeType_name[2163:2186],
	535:  _NodeType_name[2186:2196],
	540:  _NodeType_name[2196:2217],
	541:  _NodeType_name[2217:2240],
	542:  _NodeType_name[2240:2266],
	543:  _NodeType_name[2266:2291],
	550:  _NodeType_name[2291:2306],
	551:  _NodeType_name[2306:2331],
	552:  _NodeType_name[2331:2357],
	1024: _NodeType_name[2357:2371],
}
