...
func _() {
	...
	_ = x[NodeBlockRefText-431]
	_ = x[NodeBlockRefID-432]
	_ = x[NodeBlockRefSpace-433]
	_ = x[NodeTypeMaxVal-1024]
}

const _NodeType_name = ""
...
var _NodeType_map = map[NodeType]string{
	...
	431:  _NodeType_name[1351:1367],
	432:  _NodeType_name[1367:1381],
	433:  _NodeType_name[1381:1398],
