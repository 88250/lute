...
func _() {
	...
	_ = x[NodeKramdownIAL-455]
	_ = x[NodeTypeMaxVal-1024]
}

const _NodeType_name = ""
...
var _NodeType_map = map[NodeType]string{
	...
	455:  _NodeType_name[1484:1499],
	1024: _NodeType_name[1499:1513],
}
