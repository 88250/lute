...
func _() {
	...
	_ = x[NodeTabItem-591]
	_ = x[NodeMindmap-600]
	_ = x[NodeMindmapItem-601]
	_ = x[NodeTypeMaxVal-1024]
}

const _NodeType_name = ""
...
var _NodeType_map = map[NodeType]string{
	...
	590:  _NodeType_name[2331:2339],
	591:  _NodeType_name[2339:2350],
	600:  _NodeType_name[2350:2361],
	601:  _NodeType_name[2361:2376],
	1024: _NodeType_name[2376:2390],
}
