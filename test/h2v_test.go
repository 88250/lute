...
var html2VditorDOMTests = []parseTest{
	...
	{"2", `<!--StartFragment--><span>Use<span>&nbsp;</span></span><code class="language-text">new Date()</code><span><span>&nbsp;</span>and</span><!--EndFragment-->`, "<p data-block=\"0\">Use <code marker=\"`\">\u200bnew Date()</code>\u200b and\n</p>"},
	...
	{"0", `<code class="language-text">&gt;</code>`, "<p data-block=\"0\">\u200b<code marker=\"`\">\u200b&gt;</code>\u200b\n</p>"},
}
