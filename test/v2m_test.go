...
var vditorIRDOM2MdTests = []parseTest{
	...
	{"5", "<p data-block=\"0\"><span data-type=\"code\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">`</span><code data-newline=\"1\">foo</code><span class=\"vditor-ir__marker\">`</span></span></p>", "`foo`\n"},
	...
	{"0", "<p data-block=\"0\"><span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">*</span><em data-newline=\"1\">foo</em><span class=\"vditor-ir__marker\">*</span></span></p>", "*foo*\n"},
}
...
var vditorIRBlockDOM2MdTests = []parseTest{
	...
	{"7", "<h1 data-block=\"0\" class=\"vditor-ir__node\" data-node-id=\"20210218114934-rof1mw4\" data-type=\"h\" data-marker=\"#\"><span class=\"vditor-ir__marker vditor-ir__marker--heading\" data-type=\"heading-marker\"># </span>0. foo</h1><h1 data-block=\"0\" class=\"vditor-ir__node vditor-ir__node--expand\" data-node-id=\"20210218123107-2xtvzvv\" data-type=\"h\" data-marker=\"#\"><span class=\"vditor-ir__marker vditor-ir__marker--heading\" data-type=\"heading-marker\"># </span>bar</h1>", "# 0. foo\n{: id=\"20210218114934-rof1mw4\"}\n\n# bar\n{: id=\"20210218123107-2xtvzvv\"}\n"},
	...
	{"0", "<ul data-tight=\"true\" data-marker=\"-\" data-block=\"0\" data-node-id=\"20200910154204-c4bobg8\"><li data-marker=\"-\" class=\"vditor-task\" data-node-id=\"\"><input checked=\"\" type=\"checkbox\"></li></ul>", "\n"},
}
...
var vditorIRBlockDOM2StdMdTests = []parseTest{
	...
	{"7", "<table data-block=\"0\" data-type=\"table\" data-node-id=\"20210329095451-z38gxwu\" updated=\"20210329110736\" class=\"\"><thead><tr><th>col1</th><th>col2</th><th>col3</th></tr></thead><tbody><tr><td>foo<span data-type=\"html-inline\"><span class=\"vditor-ir__br\">&lt;br /&gt;</span></span>bar</td><td> </td><td> </td></tr><tr><td> </td><td> </td><td> </td></tr></tbody></table>", "| col1         | col2 | col3 |\n| -------------- | ------ | ------ |\n| foo<br />bar |      |      |\n|              |      |      |\n"},
