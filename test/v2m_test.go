...
var vditorDOM2MdTests = []parseTest{
	...
	{"107", "<p data-block=\"0\">[^1]</p><div class=\"footnotes-defs-div\" data-type=\"footnotes-block\"><hr class=\"footnotes-defs-hr\" />\n<ol class=\"footnotes-defs-ol\"><li id=\"footnotes-def-1\" data-marker=\"^1\"><p data-block=\"0\"><wbr>\n</p></li>\n</ol></div>", "[^1]\n\n[^1]:\n"},
