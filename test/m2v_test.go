...
var md2VditorIRBlockDOMTests = []parseTest{
	...
	{"26", "<<<<<<< HEAD\n{: id=\"20210121085548-9vnyjk4\"}\n=======\n{: id=\"20210120223935-11oegu7\"}\n>>>>>>> parent of fe4124a (Revert \"commit data\")", "<div data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"git-conflict\" class=\"vditor-ir__node\"><span data-type=\"git-conflict-open-marker\"><<<<<<< HEAD</span><pre class=\"vditor-ir__marker--pre\"><code>{: id=&quot;20210121085548-9vnyjk4&quot;}\n=======\n{: id=&quot;20210120223935-11oegu7&quot;}\n</code></pre><span data-type=\"git-conflict-close-marker\">>>>>>>> parent of fe4124a (Revert \"commit data\")</span></div>"},
	...
	{"23", "![foo](bar \"*baz* $bazz$\")", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><span class=\"vditor-ir__node img--center\" data-type=\"img\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">foo</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">bar</span> <span class=\"vditor-ir__marker vditor-ir__marker--title\">\"*baz* $bazz$\"</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"bar\" alt=\"foo\" /><span class=\"vditor-ir__preview\" data-render=\"2\"><em>baz</em> <span class=\"language-math\">bazz</span></span></span></p>"},
	...
	{"20", "![foo](bar \"baz\")", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><span class=\"vditor-ir__node img--center\" data-type=\"img\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">foo</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">bar</span> <span class=\"vditor-ir__marker vditor-ir__marker--title\">\"baz\"</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"bar\" alt=\"foo\" /><span class=\"vditor-ir__preview\" data-render=\"2\">baz</span></span></p>"},
	...
	{"15", "![](assets/中文/foo.png)\n", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><span class=\"vditor-ir__node img--center\" data-type=\"img\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">assets/中文/foo.png</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"assets/中文/foo.png\" /></span></p>"},
