...
var md2VditorSVTests = []parseTest{
	...
	{"5", "> foo\n>> bar\n", "<div data-block=\"0\" data-type=\"blockquote\"><span class=\"vditor-sv__marker\">&gt; </span>foo\n<span class=\"vditor-sv__marker\">&gt; </span><span class=\"vditor-sv__marker\">&gt; </span>bar</div>"},
	{"4", "* [ ] foo", "<div data-tight=\"true\" data-type=\"task\" data-marker=\"*\" data-block=\"0\"><span data-type=\"li\" data-marker=\"*\" class=\"vditor-sv__marker--bi\">* </span> foo</div>"},
	{"3", ">>", "<div data-block=\"0\" data-type=\"blockquote\"><span class=\"vditor-sv__marker\">&gt; </span><span class=\"vditor-sv__marker\">&gt; </span></div>"},
	{"2", "> foo", "<div data-block=\"0\" data-type=\"blockquote\"><span class=\"vditor-sv__marker\">&gt; </span>foo</div>"},
	{"1", ":heart: :huaji: ❤️ ", "<p data-type=\"p\" data-block=\"0\">:heart: :huaji: ❤️</p>"},
	{"0", "* foo", "<div data-tight=\"true\" data-type=\"ul\" data-marker=\"*\" data-block=\"0\"><span data-type=\"li\" data-marker=\"*\" class=\"vditor-sv__marker--bi\">* </span>foo</div>"},
}

func TestMd2VditorSV(t *testing.T) {
	luteEngine := lute.New()
	luteEngine.ToC = true

	for _, test := range md2VditorSVTests {
		md := luteEngine.Md2VditorSVDOM(test.from)
		if test.to != md {
			t.Fatalf("test case [%s] failed\nexpected\n\t%q\ngot\n\t%q\noriginal html\n\t%q", test.name, test.to, md, test.from)
		}
	}
