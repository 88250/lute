...
var md2VditorIRBlockTests = []parseTest{
	...
	{"10", "foo#bar#baz", "<p data-block=\"0\" data-node-id=\"\" data-type=\"p\">foo<span data-type=\"tag\" class=\"vditor-ir__node vditor-ir__node--expand\"><span class=\"vditor-ir__marker vditor-ir__marker--bi\">#</span><em data-newline=\"1\">bar</em><span class=\"vditor-ir__marker vditor-ir__marker--bi\">#</span></span>baz</p>"},
