...
var md2VditorIRBlockDOMTests = []parseTest{
	...
	{"23", "![foo](bar \"*baz* $bazz$\")", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><span class=\"vditor-ir__node img--center\" data-type=\"img\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">foo</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">bar</span> <span class=\"vditor-ir__marker vditor-ir__marker--title\">\"*baz* $bazz$\"</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"bar\" alt=\"foo\" /><span class=\"vditor-ir__drag\"></span><span class=\"vditor-ir__preview\" data-render=\"2\"><em>baz</em> <span class=\"language-math\">bazz</span></span></span></p>"},
	{"22", "{{{\nfoo\n{: id=\"20201124225532-6mzfxc5\"}\n\n{{{\nbar\n{: id=\"20201124202133-sujebkr\"}\n\n{: id=\"20201124225918-sg44ucv\"}\n\n}}}\n{: id=\"20201124225743-1quklut\"}\n\nbaz\n{: id=\"20201124225821-xqjdfct\"}\n\n}}}‸\n{: id=\"20201124225824-fy4jie3\"}", "<div data-block=\"0\" data-node-id=\"20201124225824-fy4jie3\" data-type=\"super-block\"><span data-type=\"super-block-open-marker\">{{{</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"super-block-layout\"></span><p data-block=\"0\" data-node-id=\"20201124225532-6mzfxc5\" data-type=\"p\">foo</p><div data-block=\"0\" data-node-id=\"20201124225743-1quklut\" data-type=\"super-block\"><span data-type=\"super-block-open-marker\">{{{</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"super-block-layout\"></span><p data-block=\"0\" data-node-id=\"20201124202133-sujebkr\" data-type=\"p\">bar</p><span data-type=\"super-block-close-marker\">}}}</span></div><p data-block=\"0\" data-node-id=\"20201124225821-xqjdfct\" data-type=\"p\">baz‸</p><span data-type=\"super-block-close-marker\">}}}</span></div>"},
	{"21", "{{{\nfoo\n{: id=\"20201124112436-amupplg\"}\n\n}}}\n{: id=\"20201124113702-drj95ri\"}\n\nbar\n{: id=\"20201124114838-5qung2s\"}", "<div data-block=\"0\" data-node-id=\"20201124113702-drj95ri\" data-type=\"super-block\"><span data-type=\"super-block-open-marker\">{{{</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"super-block-layout\"></span><p data-block=\"0\" data-node-id=\"20201124112436-amupplg\" data-type=\"p\">foo</p><span data-type=\"super-block-close-marker\">}}}</span></div><p data-block=\"0\" data-node-id=\"20201124114838-5qung2s\" data-type=\"p\">bar</p>"},
	{"20", "![foo](bar \"baz\")", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><span class=\"vditor-ir__node img--center\" data-type=\"img\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">foo</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">bar</span> <span class=\"vditor-ir__marker vditor-ir__marker--title\">\"baz\"</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"bar\" alt=\"foo\" /><span class=\"vditor-ir__drag\"></span><span class=\"vditor-ir__preview\" data-render=\"2\">baz</span></span></p>"},
	...
	{"15", "![](assets/中文/foo.png)\n", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><span class=\"vditor-ir__node img--center\" data-type=\"img\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">assets/中文/foo.png</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"assets/中文/foo.png\" /><span class=\"vditor-ir__drag\"></span></span></p>"},
