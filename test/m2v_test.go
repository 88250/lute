...
var md2VditorIRBlockDOMTests = []parseTest{
	...
	{"27", "* {: id=\"20210221200613-7vpmc8h\"}foo\n  {: id=\"20210221195351-x5tgalq\" updated=\"20210221201411\"}\n{: id=\"20210221195349-czsad7f\" updated=\"20210221195351\"}\n\n\n{: id=\"20210215183533-l36k5mo\" type=\"doc\"}", "<ul data-marker=\"*\" data-block-index=\"1\" data-node-id=\"20210221195349-czsad7f\" updated=\"20210221195351\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"20210221200613-7vpmc8h\"><p data-block-index=\"2\" data-node-id=\"20210221195351-x5tgalq\" data-type=\"p\" updated=\"20210221201411\">foo</p></li></ul>"},
	{"26", "<<<<<<< HEAD\n{: id=\"20210121085548-9vnyjk4\"}\n=======\n{: id=\"20210120223935-11oegu7\"}\n>>>>>>> parent of fe4124a (Revert \"commit data\")", "<div data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"git-conflict\" class=\"vditor-ir__node\"><span data-type=\"git-conflict-open-marker\" class=\"vditor-ir__marker\"><<<<<<< HEAD</span><pre class=\"vditor-ir__marker--pre\"><code>{: id=&quot;20210121085548-9vnyjk4&quot;}\n=======\n{: id=&quot;20210120223935-11oegu7&quot;}\n</code></pre><span data-type=\"git-conflict-close-marker\" class=\"vditor-ir__marker\">>>>>>>> parent of fe4124a (Revert \"commit data\")</span></div>"},
	{"25", "<img src=\"https://foo?bar=baz\"/>", "<div data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"html-block\" class=\"vditor-ir__node\"><pre class=\"vditor-ir__marker--pre vditor-ir__marker\"><code data-type=\"html-block\">&lt;img src=&quot;https://foo?bar=baz&quot;/&gt;</code></pre><pre class=\"vditor-ir__preview\" data-render=\"2\"><img src=\"https://foo?bar=baz\"/></pre></div>"},
	{"24", "* foo `{: id=\"\" type=\"doc\"}` bar", "<ul data-marker=\"*\" data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"20060102150405-1a2b3c4\"><p data-block-index=\"2\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo <span data-type=\"code\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">`</span><code data-newline=\"1\">{: id=&quot;&quot; type=&quot;doc&quot;}</code><span class=\"vditor-ir__marker\">`</span></span> bar</p></li></ul>"},
	{"23", "![foo](bar \"*baz* $bazz$\")", "<p data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><span class=\"vditor-ir__node\" data-type=\"img\" style=\"display: block; text-align: center; white-space: initial;\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">foo</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">bar</span> <span class=\"vditor-ir__marker vditor-ir__marker--title\">\"*baz* $bazz$\"</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"bar\" alt=\"foo\" /><span class=\"vditor-ir__preview\" data-render=\"2\"><em>baz</em> <span class=\"language-math\">bazz</span></span></span></p>"},
	{"22", "{{{\nfoo\n{: id=\"20201124225532-6mzfxc5\"}\n\n{{{\nbar\n{: id=\"20201124202133-sujebkr\"}\n\n{: id=\"20201124225918-sg44ucv\"}\n\n}}}\n{: id=\"20201124225743-1quklut\"}\n\nbaz\n{: id=\"20201124225821-xqjdfct\"}\n\n}}}‸\n{: id=\"20201124225824-fy4jie3\"}", "<div data-block-index=\"1\" data-node-id=\"20201124225824-fy4jie3\" data-type=\"super-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"super-block-open-marker\" class=\"vditor-ir__marker\">{{{</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"super-block-layout\"></span><p data-block-index=\"2\" data-node-id=\"20201124225532-6mzfxc5\" data-type=\"p\">foo</p><div data-block-index=\"3\" data-node-id=\"20201124225743-1quklut\" data-type=\"super-block\" class=\"vditor-ir__node\"><span data-type=\"super-block-open-marker\" class=\"vditor-ir__marker\">{{{</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"super-block-layout\"></span><p data-block-index=\"4\" data-node-id=\"20201124202133-sujebkr\" data-type=\"p\">bar</p><span data-type=\"super-block-close-marker\" class=\"vditor-ir__marker\">}}}</span></div><p data-block-index=\"5\" data-node-id=\"20201124225821-xqjdfct\" data-type=\"p\">baz‸</p><span data-type=\"super-block-close-marker\" class=\"vditor-ir__marker\">}}}</span></div>"},
	{"21", "{{{\nfoo\n{: id=\"20201124112436-amupplg\"}\n\n}}}\n{: id=\"20201124113702-drj95ri\"}\n\nbar\n{: id=\"20201124114838-5qung2s\"}", "<div data-block-index=\"1\" data-node-id=\"20201124113702-drj95ri\" data-type=\"super-block\" class=\"vditor-ir__node\"><span data-type=\"super-block-open-marker\" class=\"vditor-ir__marker\">{{{</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"super-block-layout\"></span><p data-block-index=\"2\" data-node-id=\"20201124112436-amupplg\" data-type=\"p\">foo</p><span data-type=\"super-block-close-marker\" class=\"vditor-ir__marker\">}}}</span></div><p data-block-index=\"3\" data-node-id=\"20201124114838-5qung2s\" data-type=\"p\">bar</p>"},
	{"20", "![foo](bar \"baz\")", "<p data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><span class=\"vditor-ir__node\" data-type=\"img\" style=\"display: block; text-align: center; white-space: initial;\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">foo</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">bar</span> <span class=\"vditor-ir__marker vditor-ir__marker--title\">\"baz\"</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"bar\" alt=\"foo\" /><span class=\"vditor-ir__preview\" data-render=\"2\">baz</span></span></p>"},
	{"19", "<audio controls=\"controls\" src=\"assets/20201118233326-ulhglhc-record1605713606242.wav\"></audio>", "<div data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"html-block\" class=\"vditor-ir__node\"><pre class=\"vditor-ir__marker--pre vditor-ir__marker\"><code data-type=\"html-block\">&lt;audio controls=&quot;controls&quot; src=&quot;assets/20201118233326-ulhglhc-record1605713606242.wav&quot;&gt;&lt;/audio&gt;</code></pre><pre class=\"vditor-ir__preview\" data-render=\"2\"><audio controls=\"controls\" src=\"assets/20201118233326-ulhglhc-record1605713606242.wav\"></audio></pre></div>"},
	{"18", "* {: id=\"20201118232739-leknj8q\"}[ ] foo\n  {: id=\"20201118233118-tdrr6q0\"}\n\n   bar\n  {: id=\"20201118233118-y62y9hq\"}\n{: id=\"20201118232736-8ljalfq\"}", "<ul data-marker=\"*\" data-block-index=\"1\" data-node-id=\"20201118232736-8ljalfq\" data-type=\"ul\"><li data-marker=\"*\" class=\"vditor-task\" data-node-id=\"20201118232739-leknj8q\"><p data-block-index=\"2\" data-node-id=\"20201118233118-tdrr6q0\" data-type=\"p\"><input type=\"checkbox\" /> foo</p><p data-block-index=\"3\" data-node-id=\"20201118233118-y62y9hq\" data-type=\"p\">bar</p></li></ul>"},
	{"17", "* {: id=\"20201112104625-ix4w985\"}[ ] ‸\n* {: id=\"20201112110516-nrtkabp\"}[ ] bar\n{: id=\"20201112104625-zoon9oa\"}", "<ul data-marker=\"*\" data-block-index=\"1\" data-node-id=\"20201112104625-zoon9oa\" data-type=\"ul\"><li data-marker=\"*\" class=\"vditor-task\" data-node-id=\"20201112104625-ix4w985\"><p data-block-index=\"2\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><input type=\"checkbox\" /> ‸</p></li><li data-marker=\"*\" class=\"vditor-task\" data-node-id=\"20201112110516-nrtkabp\"><p data-block-index=\"3\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><input type=\"checkbox\" /> bar</p></li></ul>"},
	{"16", "foo\n`bar`\n", "<p data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo\n<span data-type=\"code\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">`</span><code data-newline=\"1\">bar</code><span class=\"vditor-ir__marker\">`</span></span></p>"},
	{"15", "![](assets/中文/foo.png)\n", "<p data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\"><span class=\"vditor-ir__node\" data-type=\"img\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">assets/中文/foo.png</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"assets/中文/foo.png\" /></span></p>"},
	{"14", "| foo |\n| - |\n| bar *baz* |\n", "<table data-block-index=\"1\" data-type=\"table\" data-node-id=\"20060102150405-1a2b3c4\"><thead><tr><th>foo</th></tr></thead><tbody><tr><td>bar <span data-type=\"em\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker vditor-ir__marker--em\">*</span><em data-newline=\"1\">baz</em><span class=\"vditor-ir__marker vditor-ir__marker--em\">*</span></span></td></tr></tbody></table>"},
	{"13", "* {: id=\"fooid\"}foo\n  * {: id=\"barid\"}bar\n  {: id=\"ul2\"}\n{: id=\"ul1\"}\n", "<ul data-marker=\"*\" data-block-index=\"1\" data-node-id=\"ul1\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"fooid\"><p data-block-index=\"2\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo</p><ul data-marker=\"*\" data-block-index=\"3\" data-node-id=\"ul2\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"barid\"><p data-block-index=\"4\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">bar</p></li></ul></li></ul>"},
	{"12", "* {: id=\"fooid\"}foo\n  * {: id=\"barid\"}bar\n  {: id=\"ul2\"}\n{: id=\"ul1\"}", "<ul data-marker=\"*\" data-block-index=\"1\" data-node-id=\"ul1\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"fooid\"><p data-block-index=\"2\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo</p><ul data-marker=\"*\" data-block-index=\"3\" data-node-id=\"ul2\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"barid\"><p data-block-index=\"4\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">bar</p></li></ul></li></ul>"},
	{"11", "* {: id=\"fooid\"}foo\n{: id=\"id\"}", "<ul data-marker=\"*\" data-block-index=\"1\" data-node-id=\"id\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"fooid\"><p data-block-index=\"2\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo</p></li></ul>"},
	{"10", "foo#bar#baz", "<p data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo<span data-type=\"tag\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker vditor-ir__marker--tag\">#</span><span class=\"vditor-ir__tag\">bar</span><span class=\"vditor-ir__marker vditor-ir__marker--tag\">#</span></span>baz</p>"},
	{"9", "foo\n((id \"text\"))bar", "<p data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo\n<span data-type=\"block-ref\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\">text</span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span></span>bar</p>"},
	{"8", "foo\n!((id \"text\"))\nbar", "<p data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo</p><div data-block-index=\"2\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"block-ref-embed\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\">text</span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><div data-block-def-id=\"id\" data-render=\"2\" data-type=\"block-render\"></div></div><p data-block-index=\"3\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">bar</p>"},
	{"7.1", "foo!((id \"text\"))", "<p data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo!<span data-type=\"block-ref\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\">text</span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span></span></p>"},
	{"7", "!((id))", "<div data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"block-ref-embed\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\"></span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><div data-block-def-id=\"id\" data-render=\"2\" data-type=\"block-render\"></div></div>"},
	{"6", "!((id \"text\"))", "<div data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"block-ref-embed\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\">text</span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><div data-block-def-id=\"id\" data-render=\"2\" data-type=\"block-render\"></div></div>"},
	{"5", "<!--foo-->\nbar", "<div data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"html-block\" class=\"vditor-ir__node\"><pre class=\"vditor-ir__marker--pre vditor-ir__marker\"><code data-type=\"html-block\">&lt;!--foo--&gt;</code></pre><pre class=\"vditor-ir__preview\" data-render=\"2\"><!--foo--></pre></div><p data-block-index=\"2\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">bar</p>"},
	...
	{"3", "```\nfoo\n```\n{: id=\"test\" bookmark=\"bookmark\"}", "<div data-block-index=\"1\" data-node-id=\"test\" bookmark=\"bookmark\" tip=\"bookmark\" data-type=\"code-block\" class=\"vditor-ir__node\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b</span><pre><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span></div>"},
	{"2", "```\nfoo\n```\n{: id=\"test\"}", "<div data-block-index=\"1\" data-node-id=\"test\" data-type=\"code-block\" class=\"vditor-ir__node\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b</span><pre><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span></div>"},
	{"1", "foo\n{: id=\"fooid\"}\nbar\n{: id=\"barid\"}", "<p data-block-index=\"1\" data-node-id=\"fooid\" data-type=\"p\">foo</p><p data-block-index=\"2\" data-node-id=\"barid\" data-type=\"p\">bar</p>"},
	{"0", "", ""},
}
...
var inlineMd2VditorIRBlockDOMTests = []parseTest{
	...
	{"0", "1. foo", "<p data-block-index=\"1\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">1. foo</p>"},
}
