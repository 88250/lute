...
var md2BlockDOMTests = []parseTest{
	...
	{"11", "foo((20210121085548-9vnyjk4 \"bar\"))**baz**\n{: id=\"20210408204847-qyy54hz\"}", "<div data-node-id=\"20210408204847-qyy54hz\" data-node-index=\"1\" data-type=\"NodeParagraph\" class=\"p\"><div contenteditable=\"true\" spellcheck=\"false\">foo<span data-type=\"block-ref\" data-id=\"20210121085548-9vnyjk4\" data-anchor=\"bar\" contenteditable=\"false\">bar</span><strong>baz</strong></div><div class=\"protyle-attr\"></div></div>"},
