...
var md2VditorTests = []parseTest{
	...
	{"14", "[^1]\n\n[^1]:\n", "<p data-block=\"0\">[^1]\n</p><div class=\"footnotes-defs-div\" data-type=\"footnotes-block\"><hr class=\"footnotes-defs-hr\" /><ol class=\"footnotes-defs-ol\"><li id=\"footnotes-def-1\" data-marker=\"^1\"></li></ol></div>"},
	...
	{"12", "foo[^1]\n[^1]:bar\n    * baz", "<p data-block=\"0\">foo[^1]\n</p><div class=\"footnotes-defs-div\" data-type=\"footnotes-block\"><hr class=\"footnotes-defs-hr\" /><ol class=\"footnotes-defs-ol\"><li id=\"footnotes-def-1\" data-marker=\"^1\"><p data-block=\"0\">bar\n</p><ul data-tight=\"true\" data-marker=\"*\" data-block=\"0\"><li data-marker=\"*\">baz</li></ul></li></ol></div>"},
