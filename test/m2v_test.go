...
var md2VditorIRBlockDOMTests = []parseTest{
	...
	{"13", "* {: id=\"fooid\"}foo\n  * {: id=\"barid\"}bar\n  {: id=\"ul2\"}\n{: id=\"ul1\"}\n", "<ul data-marker=\"*\" data-block=\"0\" data-node-id=\"ul1\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"fooid\"><p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo</p><ul data-marker=\"*\" data-block=\"0\" data-node-id=\"ul2\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"barid\"><p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">bar</p></li></ul></li></ul>"},
	{"12", "* {: id=\"fooid\"}foo\n  * {: id=\"barid\"}bar\n  {: id=\"ul2\"}\n{: id=\"ul1\"}", "<ul data-marker=\"*\" data-block=\"0\" data-node-id=\"ul1\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"fooid\"><p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo</p><ul data-marker=\"*\" data-block=\"0\" data-node-id=\"ul2\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"barid\"><p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">bar</p></li></ul></li></ul>"},
	{"11", "* {: id=\"fooid\"}foo\n{: id=\"id\"}", "<ul data-marker=\"*\" data-block=\"0\" data-node-id=\"id\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"fooid\"><p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo</p></li></ul>"},
	{"10", "foo#bar#baz", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo<span data-type=\"tag\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker vditor-ir__marker--tag\">#</span><span class=\"vditor-ir__tag\">bar</span><span class=\"vditor-ir__marker vditor-ir__marker--tag\">#</span></span>baz</p>"},
	{"9", "foo\n((id \"text\"))bar", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo\n<span data-type=\"block-ref\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\">text</span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span></span>bar</p>"},
	{"8", "foo\n!((id \"text\"))\nbar", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo</p><div data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"block-ref-embed\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\">text</span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><div data-block-def-id=\"id\" data-render=\"2\" data-type=\"block-render\"></div></div><p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">bar</p>"},
	{"7", "foo!((id \"text\"))", "<p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo!<span data-type=\"block-ref\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\">text</span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span></span></p>"},
	{"7", "!((id))", "<div data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"block-ref-embed\" data-text=\"0\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\"></span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><div data-block-def-id=\"id\" data-render=\"2\" data-type=\"block-render\"></div></div>"},
	{"6", "!((id \"text\"))", "<div data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"block-ref-embed\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">id</span><span class=\"vditor-ir__marker\"> </span><span class=\"vditor-ir__marker\">\"</span><span class=\"vditor-ir__marker vditor-ir__marker--info\">text</span><span class=\"vditor-ir__marker\">\"</span><span data-type=\"ref-text-tpl-render-result\" class=\"vditor-ir__blockref\"></span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><div data-block-def-id=\"id\" data-render=\"2\" data-type=\"block-render\"></div></div>"},
	{"5", "<!--foo-->\nbar", "<div data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"html-block\" class=\"vditor-ir__node\"><pre class=\"vditor-ir__marker--pre vditor-ir__marker\"><code data-type=\"html-block\">&lt;!--foo--&gt;</code></pre><pre class=\"vditor-ir__preview\" data-render=\"2\"><!--foo--></pre></div><p data-block=\"0\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">bar</p>"},
	{"4", "# foo\n{: id=\"test\" bookmark=\"bookmark\"}", "<h1 data-block=\"0\" class=\"vditor-ir__node\" data-node-id=\"test\" bookmark=\"bookmark\" data-type=\"h\" tip=\"bookmark\" data-marker=\"#\"><span class=\"vditor-ir__marker vditor-ir__marker--heading\" data-type=\"heading-marker\"># </span>foo</h1>"},
	{"3", "```\nfoo\n```\n{: id=\"test\" bookmark=\"bookmark\"}", "<div data-block=\"0\" data-node-id=\"test\" bookmark=\"bookmark\" tip=\"bookmark\" data-type=\"code-block\" class=\"vditor-ir__node\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b</span><pre><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span></div>"},
	{"2", "```\nfoo\n```\n{: id=\"test\"}", "<div data-block=\"0\" data-node-id=\"test\" data-type=\"code-block\" class=\"vditor-ir__node\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b</span><pre><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span></div>"},
