...
var md2VditorIRBlockDOMTests = []parseTest{
	...
	{"4", "# foo\n{: id=\"test\" bookmark=\"bookmark\"}", "<h1 data-block=\"0\" class=\"vditor-ir__node\" data-node-id=\"test\" bookmark=\"bookmark\" data-type=\"h\" id=\"test\" data-marker=\"#\"><span class=\"vditor-ir__marker vditor-ir__marker--heading\" data-type=\"heading-marker\"># </span>foo</h1>"},
