...
var md2BlockDOMTests = []parseTest{
	...
	{"9", "```abc\nfoo\n```\n{: id=\"20210408204847-qyy54hz\"}", "<div data-node-id=\"20210408204847-qyy54hz\" data-node-index=\"1\" data-type=\"NodeCodeBlock\" class=\"render-block\" data-content=\"foo\"><div>foo</div><div class=\"protyle-attr\"></div></div>"},
