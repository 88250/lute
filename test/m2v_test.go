...
var md2VditorBlockDOMTests = []parseTest{
	...
	{"3", "> foo\n> {: id=\"20210408153138-td774lp\"}\n{: id=\"20210408153137-zds0o4x\"}", "<div data-node-id=\"20210408153137-zds0o4x\" data-node-index=\"1\" data-type=\"NodeBlockquote\" class=\"blockquote\"><div data-node-id=\"20210408153138-td774lp\" data-type=\"NodeParagraph\" class=\"p\"><div contenteditable=\"true\" spellcheck=\"false\">foo</div><div class=\"vditor-attr\"></div></div></div>"},
