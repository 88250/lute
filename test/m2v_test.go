...
var md2VditorIRBlockDOMTests = []parseTest{
	...
	//{"27", "* {: id=\"20210221200613-7vpmc8h\"}foo\n  {: id=\"20210221195351-x5tgalq\" updated=\"20210221201411\"}\n{: id=\"20210221195349-czsad7f\" updated=\"20210221195351\"}\n\n\n{: id=\"20210215183533-l36k5mo\" type=\"doc\"}", "<ul data-marker=\"*\" data-node-id=\"20210221195349-czsad7f\" updated=\"20210221195351\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"20210221200613-7vpmc8h\"><p data-node-id=\"20210221195351-x5tgalq\" data-type=\"p\" updated=\"20210221201411\">foo</p></li></ul>"},
	//{"26", "<<<<<<< HEAD\n{: id=\"20210121085548-9vnyjk4\"}\n=======\n{: id=\"20210120223935-11oegu7\"}\n>>>>>>> parent of fe4124a (Revert \"commit data\")", "<div data-node-id=\"20060102150405-1a2b3c4\" data-type=\"git-conflict\" class=\"vditor-ir__node\"><span data-type=\"git-conflict-open-marker\" class=\"vditor-ir__marker\"><<<<<<< HEAD</span><pre class=\"vditor-ir__marker--pre\"><code>{: id=&quot;20210121085548-9vnyjk4&quot;}\n=======\n{: id=&quot;20210120223935-11oegu7&quot;}\n</code></pre><span data-type=\"git-conflict-close-marker\" class=\"vditor-ir__marker\">>>>>>>> parent of fe4124a (Revert \"commit data\")</span></div>"},
	//{"25", "<img src=\"https://foo?bar=baz\"/>", "<div data-node-id=\"20060102150405-1a2b3c4\" data-type=\"html-block\" class=\"vditor-ir__node\"><pre class=\"vditor-ir__marker--pre vditor-ir__marker\"><code data-type=\"html-block\">&lt;img src=&quot;https://foo?bar=baz&quot;/&gt;</code></pre><pre class=\"vditor-ir__preview\" data-render=\"2\"><img src=\"https://foo?bar=baz\"/></pre></div>"},
	//{"24", "* foo `{: id=\"\" type=\"doc\"}` bar", "<ul data-marker=\"*\" data-node-id=\"20060102150405-1a2b3c4\" data-type=\"ul\"><li data-marker=\"*\" data-node-id=\"20060102150405-1a2b3c4\"><p data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">foo <span data-type=\"code\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">`</span><code data-newline=\"1\">{: id=&quot;&quot; type=&quot;doc&quot;}</code><span class=\"vditor-ir__marker\">`</span></span> bar</p></li></ul>"},
	...
	//{"22", "{{{\nfoo\n{: id=\"20201124225532-6mzfxc5\"}\n\n{{{\nbar\n{: id=\"20201124202133-sujebkr\"}\n\n{: id=\"20201124225918-sg44ucv\"}\n\n}}}\n{: id=\"20201124225743-1quklut\"}\n\nbaz\n{: id=\"20201124225821-xqjdfct\"}\n\n}}}‸\n{: id=\"20201124225824-fy4jie3\"}", "<div data-node-id=\"20201124225824-fy4jie3\" data-type=\"super-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"super-block-open-marker\" class=\"vditor-ir__marker\">{{{</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"super-block-layout\"></span><p data-node-id=\"20201124225532-6mzfxc5\" data-type=\"p\">foo</p><div data-node-id=\"20201124225743-1quklut\" data-type=\"super-block\" class=\"vditor-ir__node\"><span data-type=\"super-block-open-marker\" class=\"vditor-ir__marker\">{{{</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"super-block-layout\"></span><p data-node-id=\"20201124202133-sujebkr\" data-type=\"p\">bar</p><span data-type=\"super-block-close-marker\" class=\"vditor-ir__marker\">}}}</span></div><p data-node-id=\"20201124225821-xqjdfct\" data-type=\"p\">baz‸</p><span data-type=\"super-block-close-marker\" class=\"vditor-ir__marker\">}}}</span></div>"},
	//{"21", "{{{\nfoo\n{: id=\"20201124112436-amupplg\"}\n\n}}}\n{: id=\"20201124113702-drj95ri\"}\n\nbar\n{: id=\"20201124114838-5qung2s\"}", "<div data-node-id=\"20201124113702-drj95ri\" data-type=\"super-block\" class=\"vditor-ir__node\"><span data-type=\"super-block-open-marker\" class=\"vditor-ir__marker\">{{{</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"super-block-layout\"></span><p data-node-id=\"20201124112436-amupplg\" data-type=\"p\">foo</p><span data-type=\"super-block-close-marker\" class=\"vditor-ir__marker\">}}}</span></div><p data-node-id=\"20201124114838-5qung2s\" data-type=\"p\">bar</p>"},
	...
	{"5", "<!--foo-->\nbar", "<div data-node-id=\"20060102150405-1a2b3c4\" data-type=\"html-block\" class=\"vditor-ir__node\"><pre class=\"vditor-ir__marker--pre vditor-ir__marker\"><code data-type=\"html-block\">&lt;!--foo--&gt;</code></pre><pre class=\"vditor-ir__preview\" data-render=\"2\"><!--foo--></pre></div><p data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">bar</p>"},
	{"4", "# foo\n{: id=\"test\" bookmark=\"bookmark\"}", "<h1 class=\"vditor-ir__node\" data-node-id=\"test\" bookmark=\"bookmark\" data-type=\"h\" tip=\"bookmark\" data-marker=\"#\"><span class=\"vditor-ir__marker vditor-ir__marker--heading\" data-type=\"heading-marker\"># </span>foo</h1>"},
	{"3", "```\nfoo\n```\n{: id=\"test\" bookmark=\"bookmark\"}", "<div data-node-id=\"test\" bookmark=\"bookmark\" tip=\"bookmark\" data-type=\"code-block\" class=\"vditor-ir__node\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b</span><pre><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span></div>"},
	{"2", "```\nfoo\n```\n{: id=\"test\"}", "<div data-node-id=\"test\" data-type=\"code-block\" class=\"vditor-ir__node\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b</span><pre><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span></div>"},
	{"1", "foo\n{: id=\"fooid\"}\nbar\n{: id=\"barid\"}", "<p data-node-id=\"fooid\" data-type=\"p\">foo</p><p data-node-id=\"barid\" data-type=\"p\">bar</p>"},
	{"0", "", ""},
}
...
var inlineMd2VditorIRBlockDOMTests = []parseTest{
	...
	{"0", "1. foo", "<p data-node-id=\"20060102150405-1a2b3c4\" data-type=\"p\">1. foo</p>"},
}
