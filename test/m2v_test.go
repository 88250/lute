...
var md2VditorIRBlockDOMTests = []parseTest{
	...
	{"15", "![](assets/中文/foo.png)\n", "<p data-block=\"0\" data-node-id=\"\" data-type=\"p\"><span class=\"vditor-ir__node\" data-type=\"img\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">assets/中文/foo.png</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><img src=\"assets/中文/foo.png\" /></span></p>"},
	...
	{"10", "foo#bar#baz", "<p data-block=\"0\" data-node-id=\"\" data-type=\"p\">foo<span data-type=\"tag\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker vditor-ir__marker--tag\">#</span><span class=\"vditor-ir__tag\">bar</span><span class=\"vditor-ir__marker vditor-ir__marker--tag\">#</span></span>baz</p>"},
