...
var h2mTests = []parseTest{
	...
	{"33", "<ol data-tight=\"true\"><li data-marker=\"1.\">foo<wbr></li></ul>", "1. foo<wbr>\n"},
	{"32", "<ul data-tight=\"true\"><li data-marker=\"*\">foo<wbr></li></ul>", "* foo<wbr>\n"},
	...
	{"24", "<ul><li data-marker=\"*\" class=\"vditor-task\"><input checked=\"\" disabled=\"\" type=\"checkbox\" /> foo<wbr></li></ul>", "* [X] foo<wbr>\n"},
	{"23", "<ul><li data-marker=\"*\" class=\"vditor-task\"><input disabled=\"\" type=\"checkbox\" /> foo<wbr></li></ul>", "* [ ] foo<wbr>\n"},
	{"22", "><wbr>", "><wbr>\n"},
