...
var spinVditorIRBlockDOMTests = []*parseTest{
	...
	{"12", "<div data-block=\"0\" data-node-id=\"20200920175435-499u6lx\" data-type=\"block-ref-embed\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">20200920142200-kibhtts</span> <span class=\"vditor-ir__blockref\">\"bar<wbr>\"</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span data-block-def-id=\"20200920142200-kibhtts\" data-render=\"2\" data-type=\"block-render\"></span></div>", "<div data-block=\"0\" data-node-id=\"20200920175435-499u6lx\" data-type=\"block-ref-embed\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">!</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">(</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">20200920142200-kibhtts</span> <span class=\"vditor-ir__blockref\">\"bar<wbr>\"</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span class=\"vditor-ir__marker vditor-ir__marker--paren\">)</span><span data-block-def-id=\"20200920142200-kibhtts\" data-render=\"2\" data-type=\"block-render\"></span></div>"},
