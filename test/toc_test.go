...
var tocTests = []parseTest{
	...
	{"1", "[toc]\n\n## array\\_contains\n", "<div class=\"vditor-toc\" data-block=\"0\" data-type=\"toc-block\" contenteditable=\"false\"><ul><li><span data-target-id=\"arraycontains\">array_contains</span></li></ul></div>\n<h2 id=\"arraycontains\">array_contains</h2>\n"},
