...
var sanitizerVditorTests = []parseTest{
	...
	{"8", "<img OnError=\"alert(1)\" src=\"bar.png\" />", "<p data-block=\"0\"><img src=\"bar.png\" alt=\"\" />\n</p>"},
	...
	{"3", "<EMBED SRC=\"data:image/svg+xml;base64,mock payload\" type=\"image/svg+xml\" AllowScriptAccess=\"always\"></EMBED>", "<p data-block=\"0\">\u200b<span class=\"vditor-wysiwyg__block\" data-type=\"html-inline\"><code data-type=\"html-inline\">\u200b&lt;embed type=&quot;image/svg+xml&quot; allowscriptaccess=&quot;always&quot;/&gt;</code></span>\u200b\n</p>"},
