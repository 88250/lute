...
var sanitizerVditorTests = []parseTest{
	...
	{"0", "foo<script>alert(1)</script>bar", "<p data-block=\"0\">foo\n</p><div class=\"vditor-wysiwyg__block\" data-type=\"html-block\" data-block=\"0\"><pre><code>&lt;script&gt;alert(1)&lt;/script&gt;</code></pre><pre class=\"vditor-wysiwyg__preview\" data-render=\"2\">  </pre></div><p data-block=\"0\">bar\n</p>"},
}
