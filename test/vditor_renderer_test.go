...
var vditorRendererTests = []*parseTest{
	...
	//{"22", "<ul><li>foo</li><li><ul><li><wbr><br /></li></ul></li></ul>", "<ul data-tight=\"true\"><li>foo</li><li><ul data-tight=\"true\"><li><wbr></li></ul></li></ul>"},
	...
	//{"10", "<ul><li class=\"vditor-task\"><input checked=\"\" type=\"checkbox\" /> foo<wbr></li></ul>", "<ul data-tight=\"true\"><li class=\"vditor-task\"><input checked=\"\" type=\"checkbox\" /> foo<wbr></li></ul>"},
	//{"9", "<ul><li class=\"vditor-task\"><input type=\"checkbox\" /> foo<wbr></li></ul>", "<ul data-tight=\"true\"><li class=\"vditor-task\"><input type=\"checkbox\" /> foo<wbr></li></ul>"},
	//{"8", "> <wbr>", "<blockquote><wbr></blockquote>"},
	//{"7", "><wbr>", "<p>><wbr></p>"},
	//{"6", "<p>> foo<wbr></p>", "<blockquote><p>foo<wbr></p></blockquote>"},
	{"5", "<p>foo</p><p><wbr><br></p>", "<p>foo</p><p><wbr><br /></p>"},
	{"4", "<ul data-tight=\"true\"><li>foo<wbr></li></ul>", "<ul data-tight=\"true\"><li>foo<wbr></li></ul>"},
