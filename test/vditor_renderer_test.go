...
var spinVditorDOMTests = []*parseTest{
	...
	{"37", "<blockquote><p><wbr>\n</p></blockquote>", ""},
	{"36", "<div class=\"vditor-wysiwyg__block\" data-type=\"code-block\"><pre><code data-code=\"foo\" class=\"language-go\">foo</code></pre></div>", "<div class=\"vditor-wysiwyg__block\" data-type=\"code-block\" data-block=\"0\"><pre><code data-code=\"foo\" class=\"language-go\"></code></pre></div>"},
	...
	{"10", "<ul><li data-marker=\"*\" class=\"vditor-task\"><input checked=\"\" type=\"checkbox\" /> foo<wbr></li></ul>", "<ul data-tight=\"true\" data-block=\"0\"><li data-marker=\"*\" class=\"vditor-task\" data-block=\"0\"><input checked=\"\" type=\"checkbox\" /> foo<wbr></li></ul>"},
	{"9", "<ul><li data-marker=\"*\" class=\"vditor-task\"><input type=\"checkbox\" /> foo<wbr></li></ul>", "<ul data-tight=\"true\" data-block=\"0\"><li data-marker=\"*\" class=\"vditor-task\" data-block=\"0\"><input type=\"checkbox\" /> foo<wbr></li></ul>"},
	...
	{"4", "<ul data-tight=\"true\"><li data-marker=\"*\">foo<wbr></li></ul>", "<ul data-tight=\"true\" data-block=\"0\"><li data-marker=\"*\" data-block=\"0\">foo<wbr></li></ul>"},
