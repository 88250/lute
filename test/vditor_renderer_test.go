...
var vditorRendererTests = []*vditorTest{
	...
	{&parseTest{"37", "* [ ] f", "<ul data-ntype=\"7\" data-mtype=\"1\"><li class=\"node node--block vditor-task node--expand\" data-ntype=\"8\" data-mtype=\"1\"><span class=\"marker\">* [ ]</span><input disabled=\"\" type=\"checkbox\" data-ntype=\"100\" data-mtype=\"2\" /><span data-cso=\"2\" data-ceo=\"2\"> f</span><span class=\"newline\">\n</span></li></ul>"}, 7, 7},
	{&parseTest{"36", "* [ ]", "<ul data-ntype=\"7\" data-mtype=\"1\"><li class=\"node node--block vditor-task node--expand\" data-ntype=\"8\" data-mtype=\"1\"><span class=\"marker\">* <span data-cso=\"3\" data-ceo=\"3\">[ ]</span><span class=\"newline\">\n</span></li></ul>"}, 5, 5},
	{&parseTest{"35", "![](/bar)", "<p data-ntype=\"1\" data-mtype=\"0\"><span class=\"node node--expand\"><span class=\"marker\">!</span><span class=\"marker\" data-cso=\"1\" data-ceo=\"1\">[</span><span class=\"marker\">]</span><span class=\"marker\">(</span><span class=\"marker\">/bar</span><span class=\"marker\">)</span><img src=\"/bar\" /></span><span class=\"newline\">\n\n</span></p>"}, 2, 2},
	{&parseTest{"34", ":doge:", "<p data-ntype=\"1\" data-mtype=\"0\"><span class=\"node\"><span class=\"marker\">:</span><img alt=\"doge\" class=\"emoji\" src=\"https://cdn.jsdelivr.net/npm/vditor/dist/images/emoji/doge.png\" title=\"doge\" /><span class=\"marker\" data-cso=\"1\" data-ceo=\"1\">doge:</span></span><span class=\"newline\">\n\n</span></p>"}, 2, 2},
