...
var vditorRendererTests = []*vditorTest{
	...
	{&parseTest{"28", "1  ", "<p data-ntype=\"1\" data-mtype=\"0\"><span data-cso=\"3\" data-ceo=\"3\">1  \n</span><span class=\"newline\">\n\n</span></p>"}, 3, 3},
	{&parseTest{"27", " 1", "<p data-ntype=\"1\" data-mtype=\"0\"><span data-cso=\"0\" data-ceo=\"0\"> 1\n</span><span class=\"newline\">\n\n</span></p>"}, 0, 0},
	{&parseTest{"26", "\n", "<p data-ntype=\"1\" data-mtype=\"0\"><span data-cso=\"0\" data-ceo=\"0\"></span><span class=\"newline\">\n</span></p>"}, 0, 0},
	{&parseTest{"25", ":heart: foo\n", "<p data-ntype=\"1\" data-mtype=\"0\"><span class=\"node\"><span class=\"marker\">:</span><span data-hidden=\"❤️\"></span><span class=\"marker\">heart:</span></span><span data-cso=\"4\" data-ceo=\"4\"> foo\n</span><span class=\"newline\">\n\n</span></p>"}, 11, 11},
	{&parseTest{"24", "foo:heart:bar\n", "<p data-ntype=\"1\" data-mtype=\"0\"><span>foo</span><span class=\"node\"><span class=\"marker\">:</span><span data-hidden=\"❤️\"></span><span class=\"marker\" data-cso=\"1\" data-ceo=\"1\">heart:</span></span><span>bar\n</span><span class=\"newline\">\n\n</span></p>"}, 4, 4},
	{&parseTest{"23", "-\n", "<p data-ntype=\"1\" data-mtype=\"0\"><span data-cso=\"1\" data-ceo=\"1\">-\n</span><span class=\"newline\">\n\n</span></p>"}, 1, 1},
	{&parseTest{"22", "https://hacpai.com\n", "<p data-ntype=\"1\" data-mtype=\"0\"><span data-cso=\"2\" data-ceo=\"2\">https://hacpai.com\n</span><span class=\"newline\">\n\n</span></p>"}, 2, 2},
	{&parseTest{"21", "[foo](/bar )1\n", "<p data-ntype=\"1\" data-mtype=\"0\"><a class=\"node node--expand\" href=\"/bar\" data-ntype=\"29\" data-mtype=\"2\"><span class=\"marker\">[</span><span data-cso=\"1\" data-ceo=\"1\">foo</span><span class=\"marker\">]</span><span class=\"marker\">(</span><span class=\"marker\">/bar</span><span class=\"marker\"> </span><span class=\"marker\">)</span></a><span>1\n</span><span class=\"newline\">\n\n</span></p>"}, 2, 2},
	...
	{&parseTest{"19", "* foo\n\n  bar", "<ul data-ntype=\"7\" data-mtype=\"1\"><li class=\"node node--block node--expand\" data-ntype=\"8\" data-mtype=\"1\" data-cso=\"2\" data-ceo=\"2\"><span class=\"marker\">* </span><p data-ntype=\"1\" data-mtype=\"0\"><span>foo</span><span class=\"newline\">\n\n</span></p><p data-ntype=\"1\" data-mtype=\"0\"><span>bar\n</span><span class=\"newline\">\n\n</span></p></li></ul>"}, 2, 2},
	{&parseTest{"18", "* foo\n  bar", "<ul data-ntype=\"7\" data-mtype=\"1\"><li class=\"node node--block node--expand\" data-ntype=\"8\" data-mtype=\"1\" data-cso=\"2\" data-ceo=\"2\"><span class=\"marker\">* </span><span>foo</span>\n<span>bar\n</span><span class=\"newline\">\n</span></li></ul>"}, 2, 2},
	{&parseTest{"17", "* foo\n", "<ul data-ntype=\"7\" data-mtype=\"1\"><li class=\"node node--block node--expand\" data-ntype=\"8\" data-mtype=\"1\" data-cso=\"2\" data-ceo=\"2\"><span class=\"marker\">* </span><span>foo\n</span><span class=\"newline\">\n</span></li></ul>"}, 2, 2},
	{&parseTest{"16", ">一二\n", "<blockquote class=\"node node--block node--expand\" data-ntype=\"5\" data-mtype=\"1\"><span class=\"marker\">></span><p data-ntype=\"1\" data-mtype=\"0\"><span data-cso=\"1\" data-ceo=\"1\">一二\n</span><span class=\"newline\">\n\n</span></p></blockquote>"}, 2, 2},
	{&parseTest{"15", "一\n\n二\n\n三\n", "<p data-ntype=\"1\" data-mtype=\"0\"><span data-cso=\"2\" data-ceo=\"2\">一</span><span class=\"newline\">\n\n</span></p><p data-ntype=\"1\" data-mtype=\"0\"><span>二</span><span class=\"newline\">\n\n</span></p><p data-ntype=\"1\" data-mtype=\"0\"><span>三\n</span><span class=\"newline\">\n\n</span></p>"}, 2, 2},
	{&parseTest{"14", "fo\n", "<p data-ntype=\"1\" data-mtype=\"0\"><span data-cso=\"2\" data-ceo=\"2\">fo\n</span><span class=\"newline\">\n\n</span></p>"}, 2, 2},
	...
	{&parseTest{"11", "> # foo\n", "<blockquote class=\"node node--block node--expand\" data-ntype=\"5\" data-mtype=\"1\"><span class=\"marker\" data-cso=\"2\" data-ceo=\"2\">> </span><h1 class=\"node\" data-ntype=\"2\" data-mtype=\"0\"><span class=\"marker\"># </span><span>foo\n</span></h1></blockquote>"}, 2, 2},
	...
	{&parseTest{"9", "> ## foo\n", "<blockquote class=\"node node--block node--expand\" data-ntype=\"5\" data-mtype=\"1\"><span class=\"marker\" data-cso=\"2\" data-ceo=\"2\">> </span><h2 class=\"node\" data-ntype=\"2\" data-mtype=\"0\"><span class=\"marker\">## </span><span>foo\n</span></h2></blockquote>"}, 2, 2},
	{&parseTest{"8", "-- ---\n", "<div class=\"node node--block node--hr\"><span class=\"marker\" data-cso=\"2\" data-ceo=\"2\">-- ---\n</span><hr /><span class=\"newline\">\n\n</span></div>"}, 2, 2},
	...
	{&parseTest{"6", "`foo`\n", "<p data-ntype=\"1\" data-mtype=\"0\"><code class=\"node node--expand\" data-ntype=\"23\" data-mtype=\"2\"><span class=\"marker\">`</span>foo<span class=\"marker\">`\n</span></code><span class=\"newline\">\n\n</span></p>"}, 2, 2},
	...
	{&parseTest{"3", "> foo\n", "<blockquote class=\"node node--block node--expand\" data-ntype=\"5\" data-mtype=\"1\"><span class=\"marker\" data-cso=\"2\" data-ceo=\"2\">> </span><p data-ntype=\"1\" data-mtype=\"0\"><span>foo\n</span><span class=\"newline\">\n\n</span></p></blockquote>"}, 2, 2},
	{&parseTest{"2", "## foo\n", "<h2 class=\"node node--expand\" data-ntype=\"2\" data-mtype=\"0\"><span class=\"marker\" data-cso=\"2\" data-ceo=\"2\">## </span><span>foo\n</span></h2>"}, 2, 2},
	...
	{&parseTest{"0", "foo\n", "<p data-ntype=\"1\" data-mtype=\"0\"><span data-cso=\"2\" data-ceo=\"2\">foo\n</span><span class=\"newline\">\n\n</span></p>"}, 2, 2},
}
