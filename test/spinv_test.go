...
var spinVditorIRDOMTests = []*parseTest{
	...
	{"13", "<p data-block=\"0\">#<wbr> f\n</p>", "<h1 data-block=\"0\" class=\"vditor-ir__node vditor-ir__node--expand\" data-marker=\"#\"><span class=\"vditor-ir__marker vditor-ir__marker--heading\"># </span><wbr>f</h1>"},
	{"12", "<p data-block=\"0\"><span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">$</span><code data-newline=\"1\" class=\"vditor-ir__marker vditor-ir__marker--pre\">ab<wbr></code><span class=\"vditor-ir__preview\" data-render=\"false\"><code class=\"language-math\"><span class=\"vditor-math\" data-math=\"a\"><span class=\"katex\"><span class=\"katex-html\" aria-hidden=\"true\"><span class=\"base\"><span class=\"strut\"></span><span class=\"mord mathdefault\">a</span></span></span></span></span></code></span><span class=\"vditor-ir__marker\">$</span></span></p>", "<p data-block=\"0\"><span data-type=\"inline-node\" class=\"vditor-ir__node vditor-ir__node--expand\"><span class=\"vditor-ir__marker\">$</span><code data-newline=\"1\" class=\"vditor-ir__marker vditor-ir__marker--pre\">ab<wbr></code><span class=\"vditor-ir__preview\" data-render=\"false\"><code class=\"language-math\">ab<wbr></code></span><span class=\"vditor-ir__marker\">$</span></span>\n</p>"},
	{"11", "<div data-block=\"0\" data-type=\"math-block\" class=\"vditor-ir__node\"><span data-type=\"math-block-open-marker\">$$</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code data-type=\"math-block\">foo</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code data-type=\"math-block\">foo\n</code></pre><span data-type=\"math-block-close-marker\">$$</span></div>", "<div data-block=\"0\" data-type=\"math-block\" class=\"vditor-ir__node\"><span data-type=\"math-block-open-marker\">$$</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code data-type=\"math-block\" class=\"language-math\">foo</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code data-type=\"math-block\" class=\"language-math\">foo</code></pre><span data-type=\"math-block-close-marker\">$$</span></div>"},
	{"10", "<p data-block=\"0\">foo<span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker--link\">&lt;bar&gt;</span></span>baz<wbr>\n</p>", "<p data-block=\"0\">foo<span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker--link\">&lt;bar&gt;</span></span>baz<wbr>\n</p>"},
	{"9", "<p data-block=\"0\"><span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">$</span><code data-newline=\"1\">foo</code><span class=\"vditor-ir__marker\">$</span></span>\n</p>", "<p data-block=\"0\"><span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">$</span><code data-newline=\"1\" class=\"vditor-ir__marker vditor-ir__marker--pre\">foo</code><span class=\"vditor-ir__preview\" data-render=\"false\"><code class=\"language-math\">foo</code></span><span class=\"vditor-ir__marker\">$</span></span>\n</p>"},
	{"8", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">​java</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code class=\"language-java\">foo<wbr>\n</code></pre><span data-type=\"code-block-close-marker\">```</span></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200bjava</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code class=\"language-java\">foo<wbr>\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code class=\"language-java\">foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span></div>"},
	{"7", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\" data-type=\"code-block-open-marker\">```<wbr></span><pre><code class=\"language-j\">foo\n</code></pre><span class=\"vditor-ir__marker\" data-type=\"code-block-close-marker\">```</span></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b<wbr></span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code>foo\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span></div>"},
	{"6", "<p data-block=\"0\">```<wbr>\n</p>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b<wbr></span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code><wbr>\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code></code></pre><span data-type=\"code-block-close-marker\">```</span></div>"},
