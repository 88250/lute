...
var spinVditorIRDOMTests = []*parseTest{
	...
	{"6", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\" data-type=\"block-node\">```</span><pre><code>f<wbr>\n</code></pre><span class=\"vditor-ir__marker\" data-type=\"block-node\">```</span></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span class=\"vditor-ir__marker\" data-type=\"block-node\">```</span><pre><code>f<wbr>\n</code></pre><span class=\"vditor-ir__marker\" data-type=\"block-node\">```</span></div>"},
