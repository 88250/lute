...
var spinVditorIRDOMTests = []*parseTest{
	...
	{"16", "<div data-block=\"0\" data-type=\"math-block\" class=\"vditor-ir__node\"><span data-type=\"math-block-open-marker\">$$</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code data-type=\"math-block\">foo</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code data-type=\"math-block\">foo\n</code></pre><span data-type=\"math-block-close-marker\">$$</span><span data-type=\"math-block-close-marker-zwsp\">\u200b</span></div>", "<div data-block=\"0\" data-type=\"math-block\" class=\"vditor-ir__node\"><span data-type=\"math-block-open-marker\">$$</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code data-type=\"math-block\">foo</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code data-type=\"math-block\">foo</code></pre><span data-type=\"math-block-close-marker\">$$</span><span data-type=\"math-block-close-marker-zwsp\">\u200b</span></div>"},
	{"15", "<p data-block=\"0\">foo<span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker--link\">&lt;bar&gt;</span></span>baz<wbr>\n</p>", "<p data-block=\"0\">foo<span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker--link\">&lt;bar&gt;</span></span>baz<wbr>\n</p>"},
	{"14", "<p data-block=\"0\"><span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">$</span><code data-newline=\"1\">foo</code><span class=\"vditor-ir__marker\">$</span></span>\n</p>", "<p data-block=\"0\"><span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">$</span><code data-newline=\"1\">foo</code><span class=\"vditor-ir__marker\">$</span></span>\n</p>"},
	{"13", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker\" data-type=\"code-block-info\">​</span><pre><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span><wbr><br></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code>foo<wbr>\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span><span data-type=\"code-block-close-marker-zwsp\">\u200b</span></div>"},
	{"12", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker\" data-type=\"code-block-info\">​</span><pre><code>\n</code></pre><span data-type=\"code-block-close-marker\">```</span><span data-type=\"code-block-close-marker-zwsp\">​<wbr></span></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code><wbr>\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code>\n</code></pre><span data-type=\"code-block-close-marker\">```</span><span data-type=\"code-block-close-marker-zwsp\">\u200b</span></div>"},
	{"11", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\" data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker\" data-type=\"code-block-info\"></span><pre><code>foo\n</code></pre><span class=\"vditor-ir__marker\" data-type=\"code-block-close-marker\">``<wbr></span></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code>foo<wbr>\n``\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code>foo\n``\n</code></pre><span data-type=\"code-block-close-marker\">```</span><span data-type=\"code-block-close-marker-zwsp\">\u200b</span></div>"},
	{"10", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\" data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker\" data-type=\"code-block-info\">java</span><pre><code class=\"language-java\">foo\n</code></pre><span class=\"vditor-ir__marker\" data-type=\"code-block-close-marker\">```</span></div><div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\" data-type=\"code-block-close-marker\"><wbr><br></span></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200bjava</span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code class=\"language-java\">foo<wbr>\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code class=\"language-java\">foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span><span data-type=\"code-block-close-marker-zwsp\">\u200b</span></div><p data-block=\"0\"><wbr>\n</p>"},
	{"9", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\" data-type=\"code-block-open-marker\">```<wbr></span><pre><code class=\"language-j\">foo\n</code></pre><span class=\"vditor-ir__marker\" data-type=\"code-block-close-marker\">```</span></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b<wbr></span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code>foo<wbr>\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code>foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span><span data-type=\"code-block-close-marker-zwsp\">\u200b</span></div>"},
	{"8", "<p data-block=\"0\">```<wbr>\n</p>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200b<wbr></span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code><wbr>\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code></code></pre><span data-type=\"code-block-close-marker\">```</span><span data-type=\"code-block-close-marker-zwsp\">\u200b</span></div>"},
	{"7", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\" data-type=\"code-block-open-marker\">```j<wbr></span><span class=\"vditor-ir__marker\" data-type=\"code-block-info\"></span><pre><code></code></pre><span class=\"vditor-ir__marker\" data-type=\"code-block-close-marker\"></span></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200bj<wbr></span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code class=\"language-j\"><wbr>\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code class=\"language-j\">\n</code></pre><span data-type=\"code-block-close-marker\">```</span><span data-type=\"code-block-close-marker-zwsp\">\u200b</span></div>"},
	{"6", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\" data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker\" data-type=\"code-block-info\">java<wbr></span><pre><code class=\"language-jav\">foo</code></pre><span class=\"vditor-ir__marker\" data-type=\"code-block-close-marker\">```</span></div>", "<div data-block=\"0\" data-type=\"code-block\" class=\"vditor-ir__node vditor-ir__node--expand\"><span data-type=\"code-block-open-marker\">```</span><span class=\"vditor-ir__marker vditor-ir__marker--info\" data-type=\"code-block-info\">\u200bjava<wbr></span><pre class=\"vditor-ir__marker vditor-ir__marker--pre\"><code class=\"language-java\">foo<wbr>\n</code></pre><pre class=\"vditor-ir__preview\" data-render=\"false\"><code class=\"language-java\">foo\n</code></pre><span data-type=\"code-block-close-marker\">```</span><span data-type=\"code-block-close-marker-zwsp\">\u200b</span></div>"},
