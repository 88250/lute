...
var spinVditorIRDOMTests = []*parseTest{
	...
	{"25", "<p data-block=\"0\">[text][foo]<wbr>\n</p><div data-block=\"0\" data-type=\"link-ref-defs-block\">[foo]: bar\n</div>", "<p data-block=\"0\"><span data-type=\"a\" class=\"vditor-ir__node vditor-ir__node--expand\"><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__link vditor-ir__marker--linktext\">text</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span><span class=\"vditor-ir__marker vditor-ir__marker--link\">[foo]</span></span><wbr>\n</p><div data-block=\"0\" data-type=\"link-ref-defs-block\">[foo]: bar\n</div>"},
	{"24", "<p data-block=\"0\">[foo]<wbr>\n</p><div data-block=\"0\" data-type=\"link-ref-defs-block\">[foo]: bar\n</div>", "<p data-block=\"0\"><span data-type=\"a\" class=\"vditor-ir__node vditor-ir__node--expand\"><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span class=\"vditor-ir__link vditor-ir__marker--linktext\">foo</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span></span><wbr>\n</p><div data-block=\"0\" data-type=\"link-ref-defs-block\">[foo]: bar\n</div>"},
