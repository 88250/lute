...
var spinVditorIRDOMTests = []*parseTest{
	...
	{"27", "<div data-block=\"0\" data-type=\"footnotes-block\"><div data-type=\"footnotes-def\"><span data-type=\"footnotes-def-label\">[^fn]: </span><p data-block=\"0\">f<wbr>\n</p></div></div>", "<div data-block=\"0\" data-type=\"footnotes-block\"><div data-type=\"footnotes-def\"><span data-type=\"footnotes-def-label\">[^fn]: </span><p data-block=\"0\">f<wbr>\n</p></div></div>"},
	{"26", "<p data-block=\"0\">[^fn]: f<wbr>\n</p>", "<div data-block=\"0\" data-type=\"footnotes-block\"><div data-type=\"footnotes-def\"><span data-type=\"footnotes-def-label\">[^fn]: </span><p data-block=\"0\">f<wbr>\n</p></div></div>"},
	...
	{"24", "<p data-block=\"0\">[foo]<wbr>\n</p><div data-block=\"0\" data-type=\"link-ref-defs-block\">[foo]: bar\n</div>", "<p data-block=\"0\"><span data-type=\"link-ref\" class=\"vditor-ir__node vditor-ir__node--expand\"><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">[</span><span>foo</span><span class=\"vditor-ir__marker vditor-ir__marker--bracket\">]</span></span><wbr>\n</p><div data-block=\"0\" data-type=\"link-ref-defs-block\">[foo]: bar\n</div>"},
